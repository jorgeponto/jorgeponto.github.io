...
<tr>
 <td>1. No headings:</td>
 <td style="background-color:green; color:white; text-align:center">Yes<br />(0 headings)</td>
...
<tr>
 ...
 <td style="background-color:red; color:white; text-align:center">No</td>
...
<tr>
 ...
 <td style="background-color:green; color:white; text-align:center">No</td>
...
<tr>
 <td>7. Link text:</td>
 <td style="background-color:green; color:white; text-align:center">Yes<br />(3 instances found)</td>
...
<tr>
 <td>9. Language:</td>
 <td style="background-color:yellow; text-align:center">Partial<br />page's lang detected</td>
...
<tr>
 ...
 <td style="background-color:green; color:white; text-align:center">Yes<br />(13 inputs without labels)</td>
 <td>There are no <label>, <fieldset>, or <legend> elements in the application form.</td>
</tr>
<tr>
 <td>11. CAPTCHA:</td>
 <td style="background-color:yellow; color:red; text-align:center">Partial<br />Captcha Image w/ no alt detected</td>
...
<tr>
 <td>16. Data table:</td>
 <td style="background-color:green; color:white; text-align:center">Yes<br />(1 table without `<th>`)</td>
...
<tr>
 ...
 <td style="background-color:green; color:white; text-align:center">Yes<br />(5 HTML errors found)</td>
